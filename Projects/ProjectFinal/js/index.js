...
window.onload = function() {
    ...
    // on(people1, 'click', () => {
    //     let isAOrB = people1.getAttribute('rotate')
    //     if (isAOrB == '1') {
    //         people1.setAttribute('rotate', '0')
    //         people1.style.width = people1.getAttribute('roleWidth')
    //         people1.style.transform = 'rotateX(66deg) rotateY(-9deg) rotateZ(23deg)'
    //     } else {
    //         people1.setAttribute('rotate', '1')
    //         people1.setAttribute('roleWidth', people1.style.width)
    //         console.log(people1.style.width.split('px')[0] + people1.style.width.split('px')[0] * (3 / 4))
    //         let width = Number(people1.style.width.split('px')[0])
    //         people1.style.width = width * (1 + 1 / 2) + 'px'
    //         console.log(people1.style.width)
    //         people1.style.transform = 'rotateX(0) rotateY(0) rotateZ(0)'
    //     }
    // })
